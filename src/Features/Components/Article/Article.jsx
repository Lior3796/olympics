...
function Article() {
 ...
 useEffect(()=>{
 fetch("https://pixabay.com/api/?key=16310212-3389ee07898607be0ab5e6846&q=yellow+flowers&image_type=photo&pretty=true")
 .then(res => res.json())
 ...
 console.log(images);
    ...
    return (
        <>
    <motion.div variants={homeVariant} initial="hidden" animate="visible" className="ArticleContainer">
      {mapArticlesData()}
    </motion.div>
